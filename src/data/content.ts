...
export const strands = [
  {
    label: 'AI safety',
    text: 'Adversarial robustness, automated red-teaming, and safety training that holds up without collapsing into refusing everything.',
  },
  {
  ...
  },
  {
    ...
    text: 'Statistical and geospatial analysis for organizations that need to act on the answer.',
  },
];
...
export const projects: Project[] = [
  {
    ...
    meta: '2026 · BU CDS',
    blurb:
      'An automated red-teaming loop where attacker and defender co-evolve through LoRA fine-tuning, with an independent evaluator scoring every exchange. Compares three defender strategies under adaptive attack.',
    tags: ['LoRA', 'red-teaming', 'evaluator models', 'PyTorch'],
